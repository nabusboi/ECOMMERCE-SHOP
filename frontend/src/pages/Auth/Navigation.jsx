  ...
  return (
    <div
      ...
      className={`
        ...
        xl:flex lg:flex md:hidden sm:hidden flex-col justify-between p-4 text-white bg-[#000] 
        w-[5%] hover:w-[20%] h-[100vh] fixed transition-all duration-300 ease-in-out
      `}
    ...
    >
      ...
      <div className="relative">
        ...
        {dropdownOpen && userInfo && (
          <ul
            className="absolute right-0 mt-2 mr-14 space-y-2 bg-white text-gray-600 top-[-150px]"
          >
            {userInfo.isAdmin && (
              <>
                <li>
